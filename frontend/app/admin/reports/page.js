...
export default function ReportsPage() {
  ...
  const fetchReports = async () => {
    try {
      ...
      setAttendanceReport(attendanceData.report || []);

      setLeaveUtilization(utilizationData.report || []);

      setDepartmentStats(departmentData.report || []);

      setLeaveStatus(statusData.statistics || null);
    } catch (error) {
                ...
                onClick={() =>
                  downloadCSV(
                    [
                      {
                        Year: year,
                        "Total Requests": leaveStatus?.total || 0,
                  ...
                  onClick={() =>
                    downloadCSV(
                      departmentStats.map((department) => ({
                        ...
                        "Active Employees": department.activeEmployees,
                        Managers: department.managers,
                        "Assigned Manager": department.assignedManager,
                      })),
